...
export default class FightScene_manigbasay extends Phaser.Scene {
    ...
    init(data) {
        ...
        preload() {
            ...
            charSheets.forEach(sheet => {
                this.load.spritesheet(
                    "player_" + sheet,
                    "/assets/characters/hunter/" + sheet + ".png",
        ...
        createAnimations(prefix, enemyType=null) {
            const playerFrames = { idle:8, run:8, jump:2, fall:2, attack1:5, attack2:5, special:5, hit:3, death:8 };
        ...
        setupHealthBars(width){
            ...
            this.playerName = this.add.text(40, 70, "HUNTER", {
