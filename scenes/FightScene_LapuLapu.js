...
export default class FightScene_LapuLapu extends Phaser.Scene {
    ...
    init(data) {
        ...
        preload() {
            ...
            charSheets.forEach(sheet => {
                this.load.spritesheet(
                    "player_" + sheet,
                    "/assets/characters/LapuLapu/" + sheet + ".png",
                    { frameWidth: 180, frameHeight: 180 }
                );
            });
    
            const aiChoices = ["magellan", "hunter", "panday"];
        ...
        createAnimations(prefix, enemyType=null) {
            const playerFrames = { idle:10, run:8, jump:3, fall:3, attack1:7, attack2:7, special:8, hit:3, death:9 };
        ...
        setupHealthBars(width){
            ...
            this.playerName = this.add.text(40, 70, "LAPULAPU", {
